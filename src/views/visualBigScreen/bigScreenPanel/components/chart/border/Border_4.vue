...
<script setup lang="ts">
  ...
  const filterId = ref('border-box-03-filterId');
  ...
  const initCharts = () => {
    ...
    state.backgroundColor = props.chartConfig.bgSetting.color;
    state.borderTitle = props.chartConfig.titleSetting.borderTitle;
    state.borderTitleWidth = props.chartConfig.titleSetting.borderTitleWidth;
    state.borderTitleHeight = props.chartConfig.titleSetting.borderTitleHeight;
    state.borderTitleSize = props.chartConfig.titleSetting.borderTitleSize;
    state.borderTitleColor = props.chartConfig.titleSetting.borderTitleColor;
  };
